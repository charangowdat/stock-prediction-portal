        ...
        <div className='row'>
          <div className='col-md-6 mx-auto'>
              <form onSubmit={handleSubmit}>
                ...
                {loading ? (
                  <button type="submit" className='btn btn-info mt-3 float-end' disabled><FontAwesomeIcon icon={faSpinner} spin />Please wait...</button>
                ) :(
                  <button type='submit' className='btn btn-info mt-3 float-end'>See Prediction</button>
                )}
